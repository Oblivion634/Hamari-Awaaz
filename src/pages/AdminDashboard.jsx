    ...
    <div className="flex min-h-screen bg-gray-50">
      ...
      <AnimatePresence>
        {(sidebarOpen || isDesktop) && (
          <motion.aside
            ...
            className="fixed md:static inset-y-0 left-0 z-40 w-64 bg-gradient-to-b from-gray-900 to-gray-800 text-white shadow-lg"
          >
      ...
      <div className="flex-1">
        ...
        <div className="p-6">
                ...
                <div className="flex flex-col md:flex-row gap-4">
                  ...
                  <div className="flex-1 relative">
                    ...
                    <input
                      ...
                      className="w-full pl-12 pr-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#FF9933]"
                    />
                  </div>
          ...
          {/* Other Sections */}
          {["assign", "analytics", "users"].includes(
            activeTab
          ) && (
